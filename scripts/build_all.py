...
def main() -> None:
    ...
    (OUTPUT_DIR / SUMMARY_OUTPUT_NAME).write_text(build_summary(), encoding="utf-8")
    ...
    required = [
        f"{REPORT_OUTPUT_STEM}.tex", f"{REPORT_OUTPUT_STEM}.pdf", CHECKLIST_OUTPUT_NAME,
    ...
    report = [
        ...
        *[f"- charts_V3/{p.name}" for p in charts],
        "",
