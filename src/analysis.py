...
A 公司 2022 年营业收入为 26,373.49 万元，同比仅增长 {m['revenue_growth_2022']:.2%}；净利润 3,013.75 万元，同比增长 {m['profit_growth_2022']:.2%}。主营业务毛利率由 2020 年的 23.40% 降至 2022 年的 21.38%，服务器滑轨毛利率同期由 32.20% 降至 22.87%。这些变化是风险信号，不是已确认错报。
...
| 2022 年收入增长 | {m['revenue_growth_2022']:.2%} | 增长显著放缓，关注年末截止和异常交易 |
...
3. **存货**：年末监盘、账实抽盘、委托加工与异地存货、成本归集、库龄和期后售价、入出库截止。
